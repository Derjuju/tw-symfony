...
class TrocSection
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="TrocMessage", inversedBy="trocSection", cascade={"persist", "remove"}, orphanRemoval=true)
     * @ORM\JoinColumn(name="troc_message_id", referencedColumnName="id")
     * */
    protected $message;
    
    /**
     * @ORM\OneToOne(targetEntity="TrocContenu", inversedBy="trocSection", cascade={"persist", "remove"}, orphanRemoval=true)
     * @ORM\JoinColumn(name="troc_contenu_id", referencedColumnName="id")
     * */
    protected $contenu;
    
    /**
     * @ORM\OneToOne(targetEntity="TrocRDV", inversedBy="trocSection", cascade={"persist", "remove"}, orphanRemoval=true)
